...
public:
    ...
    QLabel *symptoms_label;
    QPlainTextEdit *symptoms_plainTextEdit;
    QFrame *room_frame;
    ...
    void setupUi(QWidget *RegisterView)
    {
        ...
        RegisterView->setMinimumSize(QSize(512, 288));
        RegisterView->setStyleSheet(QString::fromUtf8("/* ---------------------------------------------------------------------------\n"
"\n"
...
"}\n"
""));
        verticalLayout = new QVBoxLayout(RegisterView);
        verticalLayout->setSpacing(20);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        label_13 = new QLabel(RegisterView);
        ...
        label_13->setStyleSheet(QString::fromUtf8("font-size: 14pt; font-weight: bold;"));
        label_13->setAlignment(Qt::AlignCenter);

        verticalLayout->addWidget(label_13);

        frame_4 = new QFrame(RegisterView);
        frame_4->setObjectName(QString::fromUtf8("frame_4"));
        frame_4->setFrameShape(QFrame::StyledPanel);
        frame_4->setFrameShadow(QFrame::Raised);
        horizontalLayout_12 = new QHBoxLayout(frame_4);
        horizontalLayout_12->setObjectName(QString::fromUtf8("horizontalLayout_12"));
        personalInfo_groupBox = new QGroupBox(frame_4);
        ...
        sizePolicy2.setHeightForWidth(id_label->sizePolicy().hasHeightForWidth());
        id_label->setSizePolicy(sizePolicy2);
        id_label->setMinimumSize(QSize(107, 0));

        horizontalLayout_6->addWidget(id_label);

        id_lineEdit = new QLineEdit(personalInfo_groupBox);
        id_lineEdit->setObjectName(QString::fromUtf8("id_lineEdit"));

        horizontalLayout_6->addWidget(id_lineEdit);
        ...
        name_label->setMinimumSize(QSize(85, 0));
        ...
        sizePolicy2.setHeightForWidth(dob_label->sizePolicy().hasHeightForWidth());
        dob_label->setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setHeightForWidth(dob_dateEdit->sizePolicy().hasHeightForWidth());
        dob_dateEdit->setSizePolicy(sizePolicy3);
        ...
        sizePolicy2.setHeightForWidth(phone_label->sizePolicy().hasHeightForWidth());
        phone_label->setSizePolicy(sizePolicy2);
        phone_label->setMinimumSize(QSize(107, 0));

        horizontalLayout_7->addWidget(phone_label);

        phone_lineEdit = new QLineEdit(personalInfo_groupBox);
        phone_lineEdit->setObjectName(QString::fromUtf8("phone_lineEdit"));

        horizontalLayout_7->addWidget(phone_lineEdit);
        ...
        sizePolicy2.setHeightForWidth(address_label->sizePolicy().hasHeightForWidth());
        address_label->setSizePolicy(sizePolicy2);
        ...
        horizontalLayout_12->addWidget(personalInfo_groupBox);

        verticalLayout_6 = new QVBoxLayout();
        verticalLayout_6->setObjectName(QString::fromUtf8("verticalLayout_6"));
        insurance_checkBox = new QCheckBox(frame_4);
        insurance_checkBox->setObjectName(QString::fromUtf8("insurance_checkBox"));
        insurance_checkBox->setEnabled(true);
        insurance_checkBox->setChecked(true);

        verticalLayout_6->addWidget(insurance_checkBox);

        verticalSpacer = new QSpacerItem(20, 110, QSizePolicy::Minimum, QSizePolicy::Fixed);
        ...
        verticalLayout_3->setContentsMargins(-1, -1, -1, 4);
        insuranceInfo_groupBox = new QGroupBox(frame_4);
        insuranceInfo_groupBox->setObjectName(QString::fromUtf8("insuranceInfo_groupBox"));
        insuranceInfo_groupBox->setEnabled(true);
        gridLayout = new QGridLayout(insuranceInfo_groupBox);
        ...
        sizePolicy2.setHeightForWidth(issueDate_label->sizePolicy().hasHeightForWidth());
        issueDate_label->setSizePolicy(sizePolicy2);
        issueDate_label->setMinimumSize(QSize(90, 0));

        horizontalLayout_9->addWidget(issueDate_label);
        ...
        sizePolicy3.setHeightForWidth(issueDate_dateEdit->sizePolicy().hasHeightForWidth());
        issueDate_dateEdit->setSizePolicy(sizePolicy3);
        issueDate_dateEdit->setCalendarPopup(true);

        horizontalLayout_9->addWidget(issueDate_dateEdit);
        ...
        sizePolicy2.setHeightForWidth(cardId_label->sizePolicy().hasHeightForWidth());
        cardId_label->setSizePolicy(sizePolicy2);
        cardId_label->setMinimumSize(QSize(102, 0));

        horizontalLayout_8->addWidget(cardId_label);

        cardId_lineEdit = new QLineEdit(insuranceInfo_groupBox);
        cardId_lineEdit->setObjectName(QString::fromUtf8("cardId_lineEdit"));
        sizePolicy3.setHeightForWidth(cardId_lineEdit->sizePolicy().hasHeightForWidth());
        cardId_lineEdit->setSizePolicy(sizePolicy3);

        horizontalLayout_8->addWidget(cardId_lineEdit);
        ...
        sizePolicy2.setHeightForWidth(expiryDate_label->sizePolicy().hasHeightForWidth());
        expiryDate_label->setSizePolicy(sizePolicy2);
        expiryDate_label->setMinimumSize(QSize(102, 0));

        horizontalLayout_10->addWidget(expiryDate_label);
        ...
        sizePolicy3.setHeightForWidth(expiryDate_dateEdit->sizePolicy().hasHeightForWidth());
        expiryDate_dateEdit->setSizePolicy(sizePolicy3);
        expiryDate_dateEdit->setCalendarPopup(true);

        horizontalLayout_10->addWidget(expiryDate_dateEdit);
        ...
        sizePolicy2.setHeightForWidth(coveragePercent_label->sizePolicy().hasHeightForWidth());
        coveragePercent_label->setSizePolicy(sizePolicy2);
        coveragePercent_label->setMinimumSize(QSize(90, 0));

        horizontalLayout_11->addWidget(coveragePercent_label);
        ...
        sizePolicy3.setHeightForWidth(coveragePercent_doubleSpinBox->sizePolicy().hasHeightForWidth());
        coveragePercent_doubleSpinBox->setSizePolicy(sizePolicy3);
        ...
        horizontalLayout_11->addWidget(coveragePercent_doubleSpinBox);
        ...
        verticalLayout_3->addWidget(insuranceInfo_groupBox);
        ...
        symptoms_label = new QLabel(frame_6);
        symptoms_label->setObjectName(QString::fromUtf8("symptoms_label"));
        QSizePolicy sizePolicy4(QSizePolicy::Maximum, QSizePolicy::Expanding);
        sizePolicy4.setHorizontalStretch(0);
        sizePolicy4.setVerticalStretch(0);
        sizePolicy4.setHeightForWidth(symptoms_label->sizePolicy().hasHeightForWidth());
        symptoms_label->setSizePolicy(sizePolicy4);
        symptoms_label->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);

        horizontalLayout->addWidget(symptoms_label);

        symptoms_plainTextEdit = new QPlainTextEdit(frame_6);
        symptoms_plainTextEdit->setObjectName(QString::fromUtf8("symptoms_plainTextEdit"));

        horizontalLayout->addWidget(symptoms_plainTextEdit);
        ...
        room_frame = new QFrame(RegisterView);
        ...
        gridLayout_3 = new QGridLayout(room_frame);
        gridLayout_3->setObjectName(QString::fromUtf8("gridLayout_3"));

        verticalLayout->addWidget(room_frame);

        buttonBox = new QDialogButtonBox(RegisterView);
        ...
        QObject::connect(insurance_checkBox, SIGNAL(clicked(bool)), insuranceInfo_groupBox, SLOT(setEnabled(bool)));
    ...
    {
        RegisterView->setWindowTitle(QCoreApplication::translate("RegisterView", "RegisterView", nullptr));
        label_13->setText(QCoreApplication::translate("RegisterView", "\304\220\304\202NG K\303\235 KH\303\201M", nullptr));
        personalInfo_groupBox->setTitle(QCoreApplication::translate("RegisterView", "Th\303\264ng tin b\341\273\207nh nh\303\242n", nullptr));
        id_label->setText(QCoreApplication::translate("RegisterView", "M\303\243 b\341\273\207nh nh\303\242n:", nullptr));
        name_label->setText(QCoreApplication::translate("RegisterView", "H\341\273\215 t\303\252n:", nullptr));
        gender_label->setText(QCoreApplication::translate("RegisterView", "Gi\341\273\233i t\303\255nh:", nullptr));
        gender_comboBox->setItemText(0, QCoreApplication::translate("RegisterView", "Nam", nullptr));
        gender_comboBox->setItemText(1, QCoreApplication::translate("RegisterView", "N\341\273\257", nullptr));

        dob_label->setText(QCoreApplication::translate("RegisterView", "Ng\303\240y sinh:", nullptr));
        phone_label->setText(QCoreApplication::translate("RegisterView", "S\341\273\221 \304\221i\341\273\207n tho\341\272\241i:", nullptr));
        address_label->setText(QCoreApplication::translate("RegisterView", "\304\220\341\273\213a ch\341\273\211:", nullptr));
#if QT_CONFIG(tooltip)
        insurance_checkBox->setToolTip(QCoreApplication::translate("RegisterView", "S\341\273\255 d\341\273\245ng b\341\272\243o hi\341\273\203m", nullptr));
#endif // QT_CONFIG(tooltip)
        insurance_checkBox->setText(QString());
        insuranceInfo_groupBox->setTitle(QCoreApplication::translate("RegisterView", "Th\303\264ng tin b\341\272\243o hi\341\273\203m", nullptr));
        issueDate_label->setText(QCoreApplication::translate("RegisterView", "Ng\303\240y c\341\272\245p:", nullptr));
        cardId_label->setText(QCoreApplication::translate("RegisterView", "M\303\243 th\341\272\273:", nullptr));
        expiryDate_label->setText(QCoreApplication::translate("RegisterView", "Ng\303\240y h\341\272\277t h\341\272\241n:", nullptr));
        coveragePercent_label->setText(QCoreApplication::translate("RegisterView", "M\341\273\251c h\341\273\227 tr\341\273\243:", nullptr));
        coveragePercent_doubleSpinBox->setSuffix(QCoreApplication::translate("RegisterView", " %", nullptr));
        symptoms_label->setText(QCoreApplication::translate("RegisterView", "Tri\341\273\207u ch\341\273\251ng:", nullptr));
    } // retranslateUi
