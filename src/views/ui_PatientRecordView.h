/********************************************************************************
** Form generated from reading UI file 'PatientRecordView.ui'
**
...
#ifndef UI_PATIENTRECORDVIEW_H
#define UI_PATIENTRECORDVIEW_H
...
public:
    ...
    void setupUi(QDialog *PatientRecordView)
    {
        if (PatientRecordView->objectName().isEmpty())
            PatientRecordView->setObjectName(QString::fromUtf8("PatientRecordView"));
        PatientRecordView->resize(800, 450);
        PatientRecordView->setStyleSheet(QString::fromUtf8("/* ---------------------------------------------------------------------------\n"
"\n"
...
"}\n"
""));
        PatientRecordView->setModal(true);
        verticalLayout = new QVBoxLayout(PatientRecordView);
        verticalLayout->setSpacing(25);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        personalInfo_groupBox = new QGroupBox(PatientRecordView);
        ...
        dob_label->setMinimumSize(QSize(107, 0));
        ...
        sizePolicy.setHeightForWidth(dob_dateEdit->sizePolicy().hasHeightForWidth());
        dob_dateEdit->setSizePolicy(sizePolicy);
        ...
        address_label->setMinimumSize(QSize(55, 0));
        ...
        verticalLayout->addWidget(personalInfo_groupBox);

        insuranceInfo_groupBox = new QGroupBox(PatientRecordView);
        ...
        cardId_label->setMinimumSize(QSize(90, 0));

        horizontalLayout_7->addWidget(cardId_label);

        cardId_lineEdit = new QLineEdit(insuranceInfo_groupBox);
        cardId_lineEdit->setObjectName(QString::fromUtf8("cardId_lineEdit"));
        sizePolicy.setHeightForWidth(cardId_lineEdit->sizePolicy().hasHeightForWidth());
        cardId_lineEdit->setSizePolicy(sizePolicy);

        horizontalLayout_7->addWidget(cardId_lineEdit);
        ...
        horizontalLayout_8->addWidget(issueDate_label);
        ...
        sizePolicy.setHeightForWidth(issueDate_dateEdit->sizePolicy().hasHeightForWidth());
        issueDate_dateEdit->setSizePolicy(sizePolicy);
        issueDate_dateEdit->setCalendarPopup(true);

        horizontalLayout_8->addWidget(issueDate_dateEdit);
        ...
        expiryDate_label->setMinimumSize(QSize(100, 0));

        horizontalLayout_9->addWidget(expiryDate_label);
        ...
        sizePolicy.setHeightForWidth(expiryDate_dateEdit->sizePolicy().hasHeightForWidth());
        expiryDate_dateEdit->setSizePolicy(sizePolicy);
        expiryDate_dateEdit->setCalendarPopup(true);

        horizontalLayout_9->addWidget(expiryDate_dateEdit);
        ...
        horizontalLayout_10->addWidget(coveragePercent_label);
        ...
        sizePolicy.setHeightForWidth(coveragePercent_doubleSpinBox->sizePolicy().hasHeightForWidth());
        coveragePercent_doubleSpinBox->setSizePolicy(sizePolicy);
        ...
        horizontalLayout_10->addWidget(coveragePercent_doubleSpinBox);
        ...
        verticalLayout->addWidget(insuranceInfo_groupBox);

        buttonBox = new QDialogButtonBox(PatientRecordView);
        ...
        QWidget::setTabOrder(phone_lineEdit, cardId_lineEdit);
        QWidget::setTabOrder(cardId_lineEdit, coveragePercent_doubleSpinBox);

        retranslateUi(PatientRecordView);
        QObject::connect(buttonBox, SIGNAL(accepted()), PatientRecordView, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), PatientRecordView, SLOT(reject()));

        QMetaObject::connectSlotsByName(PatientRecordView);
    } // setupUi

    void retranslateUi(QDialog *PatientRecordView)
    {
        PatientRecordView->setWindowTitle(QCoreApplication::translate("PatientRecordView", "PatientRecordView", nullptr));
        personalInfo_groupBox->setTitle(QCoreApplication::translate("PatientRecordView", "Th\303\264ng tin c\303\241 nh\303\242n", nullptr));
        id_label->setText(QCoreApplication::translate("PatientRecordView", "M\303\243 b\341\273\207nh nh\303\242n:", nullptr));
        name_label->setText(QCoreApplication::translate("PatientRecordView", "H\341\273\215 t\303\252n:", nullptr));
        gender_label->setText(QCoreApplication::translate("PatientRecordView", "Gi\341\273\233i t\303\255nh:", nullptr));
        gender_comboBox->setItemText(0, QCoreApplication::translate("PatientRecordView", "Nam", nullptr));
        gender_comboBox->setItemText(1, QCoreApplication::translate("PatientRecordView", "N\341\273\257", nullptr));

        dob_label->setText(QCoreApplication::translate("PatientRecordView", "Ng\303\240y sinh:", nullptr));
        address_label->setText(QCoreApplication::translate("PatientRecordView", "\304\220\341\273\213a ch\341\273\211:", nullptr));
        phone_label->setText(QCoreApplication::translate("PatientRecordView", "S\341\273\221 \304\221i\341\273\207n tho\341\272\241i:", nullptr));
        insuranceInfo_groupBox->setTitle(QCoreApplication::translate("PatientRecordView", "Th\303\264ng tin b\341\272\243o hi\341\273\203m", nullptr));
        cardId_label->setText(QCoreApplication::translate("PatientRecordView", "M\303\243 th\341\272\273:", nullptr));
        issueDate_label->setText(QCoreApplication::translate("PatientRecordView", "Ng\303\240y c\341\272\245p:", nullptr));
        expiryDate_label->setText(QCoreApplication::translate("PatientRecordView", "Ng\303\240y h\341\272\277t h\341\272\241n:", nullptr));
        coveragePercent_label->setText(QCoreApplication::translate("PatientRecordView", "M\341\273\251c h\341\273\227 tr\341\273\243:", nullptr));
        coveragePercent_doubleSpinBox->setSuffix(QCoreApplication::translate("PatientRecordView", " %", nullptr));
    } // retranslateUi

};

namespace Ui {
    class PatientRecordView: public Ui_PatientRecordView {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PATIENTRECORDVIEW_H
