/********************************************************************************
** Form generated from reading UI file 'EmployeeFilteringView.ui'
**
...
#ifndef UI_EMPLOYEEFILTERINGVIEW_H
#define UI_EMPLOYEEFILTERINGVIEW_H
...
class Ui_EmployeeFilteringView
{
public:
    ...
    QComboBox *salary_comboBox;
    QHBoxLayout *horizontalLayout_4;
    QLabel *education_label;
    QComboBox *education_comboBox;
    QHBoxLayout *horizontalLayout_5;
    QLabel *role_label;
    QComboBox *role_comboBox;
    QDialogButtonBox *buttonBox;

    void setupUi(QDialog *EmployeeFilteringView)
    {
        if (EmployeeFilteringView->objectName().isEmpty())
            EmployeeFilteringView->setObjectName(QString::fromUtf8("EmployeeFilteringView"));
        EmployeeFilteringView->resize(431, 400);
        EmployeeFilteringView->setStyleSheet(QString::fromUtf8("/* ---------------------------------------------------------------------------\n"
"\n"
...
"}\n"
""));
        EmployeeFilteringView->setModal(true);
        verticalLayout = new QVBoxLayout(EmployeeFilteringView);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        verticalLayout->setContentsMargins(30, -1, 30, -1);
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        id_label = new QLabel(EmployeeFilteringView);
        ...
        id_label->setMinimumSize(QSize(70, 0));

        horizontalLayout->addWidget(id_label);

        id_lineEdit = new QLineEdit(EmployeeFilteringView);
        ...
        salary_label = new QLabel(EmployeeFilteringView);
        ...
        salary_label->setMinimumSize(QSize(70, 0));

        horizontalLayout_3->addWidget(salary_label);

        salary_doubleSpinBox = new QDoubleSpinBox(EmployeeFilteringView);
        salary_doubleSpinBox->setObjectName(QString::fromUtf8("salary_doubleSpinBox"));
        salary_doubleSpinBox->setMinimumSize(QSize(0, 32));
        salary_doubleSpinBox->setMaximum(1000000000.000000000000000);
        salary_doubleSpinBox->setSingleStep(1000000.000000000000000);

        horizontalLayout_3->addWidget(salary_doubleSpinBox);

        salary_comboBox = new QComboBox(EmployeeFilteringView);
        salary_comboBox->addItem(QString());
        salary_comboBox->addItem(QString());
        salary_comboBox->addItem(QString());
        salary_comboBox->addItem(QString());
        salary_comboBox->addItem(QString());
        salary_comboBox->addItem(QString());
        salary_comboBox->setObjectName(QString::fromUtf8("salary_comboBox"));

        horizontalLayout_3->addWidget(salary_comboBox);
        ...
        education_label = new QLabel(EmployeeFilteringView);
        ...
        education_label->setMinimumSize(QSize(70, 0));

        horizontalLayout_4->addWidget(education_label);

        education_comboBox = new QComboBox(EmployeeFilteringView);
        education_comboBox->addItem(QString());
        education_comboBox->addItem(QString());
        education_comboBox->addItem(QString());
        education_comboBox->addItem(QString());
        education_comboBox->addItem(QString());
        ...
        education_comboBox->addItem(QString());
        education_comboBox->addItem(QString());
        education_comboBox->setObjectName(QString::fromUtf8("education_comboBox"));

        horizontalLayout_4->addWidget(education_comboBox);
        ...
        role_label = new QLabel(EmployeeFilteringView);
        ...
        role_label->setMinimumSize(QSize(70, 0));

        horizontalLayout_5->addWidget(role_label);

        role_comboBox = new QComboBox(EmployeeFilteringView);
        ...
        horizontalLayout_5->addWidget(role_comboBox);


        verticalLayout->addLayout(horizontalLayout_5);

        buttonBox = new QDialogButtonBox(EmployeeFilteringView);
        ...
        retranslateUi(EmployeeFilteringView);
        QObject::connect(buttonBox, SIGNAL(accepted()), EmployeeFilteringView, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), EmployeeFilteringView, SLOT(reject()));

        QMetaObject::connectSlotsByName(EmployeeFilteringView);
    } // setupUi

    void retranslateUi(QDialog *EmployeeFilteringView)
    {
        EmployeeFilteringView->setWindowTitle(QCoreApplication::translate("EmployeeFilteringView", "EmployeeFilteringView", nullptr));
        id_label->setText(QCoreApplication::translate("EmployeeFilteringView", "M\303\243 NV:", nullptr));
        name_label->setText(QCoreApplication::translate("EmployeeFilteringView", "H\341\273\215 t\303\252n:", nullptr));
        salary_label->setText(QCoreApplication::translate("EmployeeFilteringView", "L\306\260\306\241ng:", nullptr));
        salary_comboBox->setItemText(0, QCoreApplication::translate("EmployeeFilteringView", "B\341\272\261ng", nullptr));
        salary_comboBox->setItemText(1, QCoreApplication::translate("EmployeeFilteringView", "Kh\303\264ng b\341\272\261ng", nullptr));
        salary_comboBox->setItemText(2, QCoreApplication::translate("EmployeeFilteringView", "L\341\273\233n h\306\241n", nullptr));
        salary_comboBox->setItemText(3, QCoreApplication::translate("EmployeeFilteringView", "Nh\341\273\217 h\306\241n", nullptr));
        salary_comboBox->setItemText(4, QCoreApplication::translate("EmployeeFilteringView", "L\341\273\233n h\306\241n ho\341\272\267c b\341\272\261ng", nullptr));
        salary_comboBox->setItemText(5, QCoreApplication::translate("EmployeeFilteringView", "Nh\341\273\217 h\306\241n ho\341\272\267c b\341\272\261ng", nullptr));

        education_label->setText(QCoreApplication::translate("EmployeeFilteringView", "H\341\273\215c v\341\272\245n:", nullptr));
        education_comboBox->setItemText(0, QCoreApplication::translate("EmployeeFilteringView", "---", nullptr));
        education_comboBox->setItemText(1, QCoreApplication::translate("EmployeeFilteringView", "C\341\273\255 Nh\303\242n", nullptr));
        education_comboBox->setItemText(2, QCoreApplication::translate("EmployeeFilteringView", "Th\341\272\241c S\304\251", nullptr));
        education_comboBox->setItemText(3, QCoreApplication::translate("EmployeeFilteringView", "Ti\341\272\277n S\304\251", nullptr));
        education_comboBox->setItemText(4, QCoreApplication::translate("EmployeeFilteringView", "Th\341\272\241c S\304\251 Y H\341\273\215c", nullptr));
        education_comboBox->setItemText(5, QCoreApplication::translate("EmployeeFilteringView", "Ti\341\272\277n S\304\251 Y H\341\273\215c", nullptr));
        education_comboBox->setItemText(6, QCoreApplication::translate("EmployeeFilteringView", "Chuy\303\252n Khoa I", nullptr));
        education_comboBox->setItemText(7, QCoreApplication::translate("EmployeeFilteringView", "Chuy\303\252n Khoa II", nullptr));

        role_label->setText(QCoreApplication::translate("EmployeeFilteringView", "Vai tr\303\262:", nullptr));
        role_comboBox->setItemText(0, QCoreApplication::translate("EmployeeFilteringView", "---", nullptr));
        role_comboBox->setItemText(1, QCoreApplication::translate("EmployeeFilteringView", "B\303\241c s\304\251", nullptr));
        role_comboBox->setItemText(2, QCoreApplication::translate("EmployeeFilteringView", "Y t\303\241", nullptr));
        role_comboBox->setItemText(3, QCoreApplication::translate("EmployeeFilteringView", "Ti\341\272\277p t\303\242n", nullptr));
...
namespace Ui {
    class EmployeeFilteringView: public Ui_EmployeeFilteringView {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_EMPLOYEEFILTERINGVIEW_H
