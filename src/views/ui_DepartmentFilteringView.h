/********************************************************************************
** Form generated from reading UI file 'DepartmentFilteringView.ui'
**
...
#ifndef UI_DEPARTMENTFILTERINGVIEW_H
#define UI_DEPARTMENTFILTERINGVIEW_H
...
class Ui_DepartmentFilteringView
{
public:
    ...
    QComboBox *foundation_comboBox;
    QDialogButtonBox *buttonBox;

    void setupUi(QDialog *DepartmentFilteringView)
    {
        if (DepartmentFilteringView->objectName().isEmpty())
            DepartmentFilteringView->setObjectName(QString::fromUtf8("DepartmentFilteringView"));
        DepartmentFilteringView->resize(450, 250);
        DepartmentFilteringView->setStyleSheet(QString::fromUtf8("/* ---------------------------------------------------------------------------\n"
"\n"
...
"}\n"
""));
        DepartmentFilteringView->setModal(true);
        verticalLayout = new QVBoxLayout(DepartmentFilteringView);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        verticalLayout->setContentsMargins(30, -1, 30, -1);
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        id_label = new QLabel(DepartmentFilteringView);
        id_label->setObjectName(QString::fromUtf8("id_label"));
        id_label->setMinimumSize(QSize(115, 0));

        horizontalLayout->addWidget(id_label);

        id_lineEdit = new QLineEdit(DepartmentFilteringView);
        ...
        name_label = new QLabel(DepartmentFilteringView);
        name_label->setObjectName(QString::fromUtf8("name_label"));
        name_label->setMinimumSize(QSize(115, 0));

        horizontalLayout_2->addWidget(name_label);

        name_lineEdit = new QLineEdit(DepartmentFilteringView);
        ...
        foundation_label = new QLabel(DepartmentFilteringView);
        foundation_label->setObjectName(QString::fromUtf8("foundation_label"));
        foundation_label->setMinimumSize(QSize(115, 0));

        horizontalLayout_3->addWidget(foundation_label);

        foundation_dateEdit = new QDateEdit(DepartmentFilteringView);
        foundation_dateEdit->setObjectName(QString::fromUtf8("foundation_dateEdit"));
        foundation_dateEdit->setMinimumSize(QSize(20, 32));
        foundation_dateEdit->setMinimumDateTime(QDateTime(QDate(1900, 1, 1), QTime(0, 0, 0)));
        foundation_dateEdit->setCalendarPopup(true);

        horizontalLayout_3->addWidget(foundation_dateEdit);

        foundation_comboBox = new QComboBox(DepartmentFilteringView);
        foundation_comboBox->addItem(QString());
        foundation_comboBox->addItem(QString());
        foundation_comboBox->addItem(QString());
        foundation_comboBox->addItem(QString());
        foundation_comboBox->addItem(QString());
        foundation_comboBox->addItem(QString());
        foundation_comboBox->setObjectName(QString::fromUtf8("foundation_comboBox"));

        horizontalLayout_3->addWidget(foundation_comboBox);


        verticalLayout->addLayout(horizontalLayout_3);

        buttonBox = new QDialogButtonBox(DepartmentFilteringView);
        ...
        retranslateUi(DepartmentFilteringView);
        QObject::connect(buttonBox, SIGNAL(accepted()), DepartmentFilteringView, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), DepartmentFilteringView, SLOT(reject()));

        QMetaObject::connectSlotsByName(DepartmentFilteringView);
    } // setupUi

    void retranslateUi(QDialog *DepartmentFilteringView)
    {
        DepartmentFilteringView->setWindowTitle(QCoreApplication::translate("DepartmentFilteringView", "DepartmentFilteringView", nullptr));
        id_label->setText(QCoreApplication::translate("DepartmentFilteringView", "M\303\243 khoa:", nullptr));
        name_label->setText(QCoreApplication::translate("DepartmentFilteringView", "T\303\252n khoa:", nullptr));
        foundation_label->setText(QCoreApplication::translate("DepartmentFilteringView", "Ng\303\240y th\303\240nh l\341\272\255p:", nullptr));
        foundation_dateEdit->setSpecialValueText(QCoreApplication::translate("DepartmentFilteringView", "Kh\303\264ng l\341\273\215c", nullptr));
        foundation_comboBox->setItemText(0, QCoreApplication::translate("DepartmentFilteringView", "B\341\272\261ng", nullptr));
        foundation_comboBox->setItemText(1, QCoreApplication::translate("DepartmentFilteringView", "Kh\303\264ng b\341\272\261ng", nullptr));
        foundation_comboBox->setItemText(2, QCoreApplication::translate("DepartmentFilteringView", "L\341\273\233n h\306\241n", nullptr));
        foundation_comboBox->setItemText(3, QCoreApplication::translate("DepartmentFilteringView", "Nh\341\273\217 h\306\241n", nullptr));
        foundation_comboBox->setItemText(4, QCoreApplication::translate("DepartmentFilteringView", "L\341\273\233n h\306\241n ho\341\272\267c b\341\272\261ng", nullptr));
        foundation_comboBox->setItemText(5, QCoreApplication::translate("DepartmentFilteringView", "Nh\341\273\217 h\306\241n ho\341\272\267c b\341\272\261ng", nullptr));
...
namespace Ui {
    class DepartmentFilteringView: public Ui_DepartmentFilteringView {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DEPARTMENTFILTERINGVIEW_H
