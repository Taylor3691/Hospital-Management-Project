...
public:
    ...
    MedicineUsage* createMedicneUsage(const std::string& medicineId,
        const std::string& name, int quantity, double price,
        const std::string& description);
    ClinicalTest* createCinicalTest(const std::string& testId,
